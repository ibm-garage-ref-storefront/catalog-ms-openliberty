package dev.appsody.application.rest;
...
import dev.appsody.application.client.Item;
    ...
    public void run() {
        while (true) {
            try {
                ...
                final List<dev.appsody.application.models.Item> modelItems = new ArrayList<dev.appsody.application.models.Item>(allItems.size());
